...
<?php
    ...
    if(isset($_POST['editEmpTask'])){
        ...
        $insert ="UPDATE `tasks` SET `title`='$title', `empRes`='$empRes' ,`deadline`='$deadline', `empID`='$empID',`status`='$status'  WHERE `task_id`='$_GET[task]' ";
        ...
        if(isset($inser_sql)){
            ...
            echo '<meta http-equiv="refresh" content="3; \'empTasks.php\'">';
        }
    }
?>
                ...
                <div class="panel-heading"><b>  تعديل المهمة  </b><?php echo $task['title']; ?></div>
                    ...
                    <div class="panel-body"> 
                            ...
                            <div class="input-group">
                                ...
                                <select name="empID" >  
                                    <option value="<?=$task["empID"];?> " title="<?=$task["empRes"];?>"><?=$task["empRes"];?>"</option>                                            
							...
							<div class="col-sm-3">
                            <select class="form-control" name="status" id="role" value="<?=$task["status"];?>" >
                            <option value="<?=$task["status"];?>" ><?php echo $task['status'];  ?></option>
                            ...
                            <div class="col-sm-offset-2 col-sm-10">
                                <button type="submit" name="editEmpTask" class="btn btn-danger">تعديل</button>
                            </div>
                            </div>
                        </form>
