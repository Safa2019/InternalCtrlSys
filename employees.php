<?php include_once("include/confg.php");
	...
	if(isset($_GET['delete'])){
		...
		if(isset($sql)){
			$msg = '<div class="alert alert-success" role="alert"> تم حذف الموظف بنجاح</div>';
			}
	}
...
<section class="container-fluid" dir="rtl" style="margin-top:30px;">
    ...
    <article class="col-lg-9">
        <a href="addEmp.php" class="btn btn-info" >إضافة موظف </a>
		<hr/>
		<div class="row">
            <div class="col-md-12">	
                <div class="panel panel-info">
                    <div class="panel-heading"><b>الموظفين</b></div><br>
                                ...
                                <?php 
                                    ...
                                    while($user = mysqli_fetch_assoc($users)){
                                            ...
                                            <tr>
                                                ...
                                                <td>'.$user['empName'].'</td>
                                                <td>'.$user['username'].'</td>
                                                <td><a href="editEmp.php?user='.$user['user_id'].'" class="btn btn-warning btn-xs">تعديل</a></td>
                                                <td><a href="employees.php?delete='.$user['user_id'].'" class="btn btn-danger btn-xs">حذف</a></td>
                                            </tr>';
